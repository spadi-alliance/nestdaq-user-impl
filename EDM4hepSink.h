...
class EDM4hepSink : public fair::mq::Device {
public:
    struct OptionKey {
    ...
    EDM4hepSink() : FairMQDevice() {}
    EDM4hepSink(const EDM4hepSink &) = delete;
    EDM4hepSink &operator=(const EDM4hepSink &) = delete;
    ~EDM4hepSink() override = default;
