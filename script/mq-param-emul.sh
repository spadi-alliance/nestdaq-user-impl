...
param  Sampler-0      text   Hello    msiTcpIp  192.168.2.171    TdcType   2       max-iterations 0     MaxHBF  256    sflag   1
param  Sampler-1      text   world    msiTcpIp  192.168.2.169    TdcType   2       max-iterations 0     MaxHBF  256    sflag   1      
