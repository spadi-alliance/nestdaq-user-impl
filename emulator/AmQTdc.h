...
public :
    ...
    void set_HBrate(unsigned int rate) {
        HBrate = rate;
    }
    unsigned int get_HBrate() {
        return HBrate;
    }

    void set_WordCount(int fnWordCount) {
        nWordCount = fnWordCount;
    }
    unsigned int get_WCount() {
        return nWordCount;
    }
